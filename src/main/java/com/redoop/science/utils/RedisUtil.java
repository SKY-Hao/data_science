...
public  class RedisUtil<T> {
     ...
     * @return
     */
//    public  T getHashKey(String key, String hashKey) {
...
//    }
     ...
     * @return
     */
    public  Map<String, Set<ConfigAttribute>> getHashEntriesAuth(String key) {
        Map<Object,Object> entries = redisTemplate.opsForHash().entries(key);
        return JSONObject.parseObject(JSON.toJSONString(entries),Map.class);
    }
     ...
     * @return
     */
//    public  Set<T> hashKeys(String key) {
...
/*    public  List<T> listRange(String key, long start, long end) {
     ...
     * @return 操作的值
     */
/*    public  T  rightPopAndLeftPush(String key, String key2) {
...
/*    public  Set<T>  difference(String key, String otherKey) {
     ...
     * @return
     */
/*    public  Set<T>  difference(String key, Collection<Object> otherKeys) {
